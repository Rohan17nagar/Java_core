...
<div class="header-image">
  <div class="header-text">
    <h1 style="font-size:50px">Welcome To Placement Cell Placement Officer Login</h1>
    <p></p>
    <!--  <button></button> -->
  </div>
</div>
...
<form name="regForm" action="POfficerLoginCheck.jsp" method="post" onsubmit="return validation()" class="container" >
